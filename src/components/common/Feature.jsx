  ...
  return (
    <div className='bg-[#F6F6F6] rounded-[30px] px-6 py-2 absolute left-[10vw]'>
        <div className='flex gap-6'>
            <div onClick={()=> navigate('/convert')} className='flex gap-6 border border-[#000000] rounded-[30px] px-6 py-2 w-[350px] h-[144px] cursor-pointer'>
            ...
            <div onClick={()=> navigate('/otc')} className='flex gap-6 border border-[#000000] rounded-[30px] px-6 py-2 w-[350px] h-[144px] cursor-pointer'>
