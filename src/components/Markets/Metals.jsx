            ...
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        <img src="../87496d50-2408-43e1-ad4c-78b47b448a6a.png.png" alt="" />
                        <p className='text-[#EAECEF]'>XAUUSD</p>
                        <p className='text-[#848E9C] text-[14px] '>Gold</p>
                    </div>
                </td>
            ...
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        ...
                        <p className='text-[#EAECEF]'>XAGUSD</p>
                        <p className='text-[#848E9C] text-[14px] '>Silver</p>
                    </div>
                </td>
