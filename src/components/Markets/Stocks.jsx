        ...
        <table className="w-full text-sm text-left my-6">
          ...
          <tbody>
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        <img src="../87496d50-2408-43e1-ad4c-78b47b448a6a.png (2).png" alt="" />
                        <p className='text-[#EAECEF]'>Apple Inc</p>
            ...
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        <img src="../3a8c9fe6-2a76-4ace-aa07-415d994de6f0.png (3).png" alt="" />
                        <p className='text-[#EAECEF]'>Amazon.com Inc</p>
            ...
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        <img src="../6180cdb6-8480-4a3c-a8a9-8a193a89fc5e.png (1).png" alt="" />
                        <p className='text-[#EAECEF]'>ICICI</p>
            ...
            <tr className=" ">
                <td className="py-4">
                    <div className='flex items-center gap-1 '>
                        <img src="../94863af2-c980-42cf-a139-7b9f462a36c2.png.png" alt="" />
                        <p className='text-[#EAECEF]'>HDFCBank</p>
